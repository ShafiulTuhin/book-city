      ...
      <div className="max-w-4xl mx-auto bg-white rounded-2xl shadow-lg p-6 md:p-10">
        ...
        <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-8 lg:px-20">
          ...
          <div className="space-y-4 text-center md:text-left">
            ...
            {/* Button */}
            <Link href={"/my-profile/update-user"}>
              {" "}
              <button className="mt-4 btn bg-[#f59e0b] text-[#081f30] font-semibold px-6 py-2 rounded-lg hover:opacity-90 transition cursor-pointer">
                Update Profile
              </button>
            </Link>
          </div>
